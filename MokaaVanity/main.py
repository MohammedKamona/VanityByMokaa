...
class Discord():
    ...
    def __init__(self):
        ctypes.windll.kernel32.SetConsoleTitleW("MrMokaa.exe")
    ...
    def run(self): 
        ...
        self.vanity = input("\x1b[38;2;73;73;73m[\x1b[0m%s\x1b[38;2;73;73;73m]\x1b[0m VANTIY / SHORT CUT OF URL\x1b[38;2;73;73;73m:\x1b[0m " % (self.timestamp()))
